            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form:form role="form" method="post" action="${pageContext.request.contextPath}/login" modelAttribute="loginForm">
                            <fieldset>
                                <form:errors path="*" element="div"/>
                                <div class="form-group">
                                    <form:input class="form-control" placeholder="Username" path="username" type="text"/>
                                </div> <form:errors path="username" element="div"/>
                                <div class="form-group">
                                    <form:input class="form-control" placeholder="Password" path="password" type="password" />
                                </div> <form:errors path="password" element="div"/>
